...
namespace SpaceKarts.Effects
{
    public class BasicModelEffect
    {
        ...
        {
            this.effect = SpaceKarts.getInstance().Content.Load<Effect>(SpaceKarts.ContentFolderEffects + effect);
        ...
        //{
        //    inverseViewProjection.SetValue(inv);
        //}
        ...
        //public void SetNormalMapTexture(Texture2D texture)
        //{
        //    this.normalMapTexture.SetValue(texture);
        //}
